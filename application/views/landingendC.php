        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="intro-message">
                    ...
                    <h3>Your password has been successfully verified!</h3>
                    <hr class="intro-divider">
                        <a href="<?php echo site_url('welcome')?>" style="font-family: Lato"><button class="btn btn-primary"><span class="glyphicon glyphicon-refresh"></span> Refresh</button></a>
                    </div>
                </div>
            </div>
        </div>
